    ...
    >
      ...
      <Box sx={{ width: "100%" }}>
        ...
        >
          ...
          <AccordionDetails>
            <Typography
              ...
              sx={{ maxWidth: { sm: "100%", md: "70%" } }}
            >
              As of recently I have taken up photography and basketball. I was
              thinking of creating a gallery website for my photos soon!
            </Typography>
          </AccordionDetails>
        </Accordion>
        <Accordion
        ...
        >
          ...
          >
            <Typography component="h3" variant="subtitle2">
              If you could only bring three movies with you to watch while
              stranded on a desert island, what would they be?
            </Typography>
          </AccordionSummary>
          <AccordionDetails>
            <Typography
